...
{
    public partial class IUONIzborFoma : Form,IInstitucijaPregled8SoIzborView,IUstanovaPregledSoFilterView,IOblastPregledSoFilterView,IPredmetNasokaAddView,IPredmetiNasokaPoNasokaPregled1View , INasokaPregled1View
    {
        ...
        private void IUONIzborFoma_Load(object sender, EventArgs e)
        {
        ...
        public int ID_Predmet_PregledIzbor_Selected
        {
            get
            {
                ...
                try
                {
                    id_predmet = ((Predmet)this.listBoxPredmeti.SelectedItem).PredmetID;
                }
                catch (Exception ex)
                {
                    //prazna lista
        ...
        private void listBoxPredmeti_DoubleClick(object sender, EventArgs e)
        {
        ...
        #endregion
        #region IPredmetNasokaAddView
        public string Ime_PredmetNasoka_Input
        {
            get
            {
                return this.txtBoxIme_NasokaPredmet_Input.Text;
            }
            set
            {
                throw new NotImplementedException();
        ...
        public string Kod_PredmetNasoka_Input
        {
            get
            {
                return this.txtBoxKod_NasokaPredmet_Input.Text;
            }
            set
            {
                throw new NotImplementedException();
        ...
        public int Krediti_PredmetNasoka_Input
        {
            get
            {
                int krediti_input = 0;
                if (this.txtBoxKrediti_NasokaPredmet_Input.Text != "")
                {
                    try
                    {
                        krediti_input =int.Parse(this.txtBoxKrediti_NasokaPredmet_Input.Text);
                    }
                    catch (Exception ex)
                    {
                    }
        ...
        private void btnDodadiPredmetNasoka_Click(object sender, EventArgs e)
        {
            this.nasokaPresenter.addPredmetZaNasoka();
            this.nasokaPresenter.pregled1PredmetiPoNasoka();
        }
        #endregion
