...
{
    /// <summary>
    /// Klasa koja regulira isklucoci koi se povrzani so poraki generirani za otvorena konekcija prema baza
    /// </summary>
    public class KonekcijaOpenEX : GlavenException 
    {
        ...
        public KonekcijaOpenEX(String KorisnickaPoraka, String SistemskaPoraka, String Message, int Kod)
