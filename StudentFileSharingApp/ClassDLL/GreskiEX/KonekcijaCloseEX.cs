...
{
    /// <summary>
    /// Klasa koja regulira isklucoci koi se povrzani so poraki generirani za zatvorena konekcija prema baza
    /// </summary>
    public class KonekcijaCloseEX : GlavenException
    {
        /// <summary>
        ...
        public KonekcijaCloseEX(String KorisnickaPoraka, String SistemskaPoraka, String Message, int Kod)
