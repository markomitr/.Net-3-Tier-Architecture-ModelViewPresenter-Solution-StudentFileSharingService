...
namespace ClassDLL.GreskiEX
{
    ...
    /// <summary>
    /// Klasa koja regulira isklucoci koi se povrzani so poraki generirani za konekciski string 
    /// </summary>
    public class KonekcijaStringEX: GlavenException 
    {
        /// <summary>
        ...
        public KonekcijaStringEX(String KorisnickaPoraka, String SistemskaPoraka, String Message, int Kod)
